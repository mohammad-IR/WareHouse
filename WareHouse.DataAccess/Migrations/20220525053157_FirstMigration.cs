        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RialValue = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrenciesPrice", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TitleJobs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeNational = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonnelCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FutherName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Landline = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LandlineInternalNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StartDateToWork = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndDateToWork = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    RegistrantionNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdMaterial = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    NumberOfMaterial = table.Column<int>(type: "int", nullable: false),
                    Limit = table.Column<int>(type: "int", nullable: false),
                    SupplierId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DateOfBuy = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PriceIR = table.Column<long>(type: "bigint", nullable: false),
                    CurrencyPriceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RawMaterials_PartNumber",
                table: "RawMaterials",
                column: "PartNumber",
                unique: true);
